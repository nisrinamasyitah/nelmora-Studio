...
-- sale_entries
-- Corrected 2026-07-19 against the real per-line sale tracker report (105
-- bottles / RM1,640 total) -- the original version of this file undercounted
-- qty per date (it only captured the first line item's quantity per date
-- instead of summing every scent sold that day). See supabase/fix_sale_entries.sql
-- for the standalone correction script run against the already-seeded database.
